...
const WordleApp = (props) => {
    ...
    const submitAnswer = () => {
        ...
        // 1. Doğru harfleri correct olarak işaretle
        for (let i = 0; i < 5; i++) {
            ...
            // 2. Harfler yazıldıkça ekrandan sil 
        ...
        //  3. Sarı-Gri renkli harfleri ilgili classa yönlendir. 
        for (let i = 0; i < 5; i++) {
    ...
    return (<div className='full_page'>
        ...
        <Navbar view={updatedLetters}></Navbar>
